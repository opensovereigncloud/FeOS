...
const (
	TaskService_Create_FullMethodName = "/feos.task.v1.TaskService/Create"
	TaskService_Start_FullMethodName  = "/feos.task.v1.TaskService/Start"
	TaskService_Kill_FullMethodName   = "/feos.task.v1.TaskService/Kill"
	TaskService_Delete_FullMethodName = "/feos.task.v1.TaskService/Delete"
	TaskService_Wait_FullMethodName   = "/feos.task.v1.TaskService/Wait"
)
...
func (c *taskServiceClient) Kill(ctx context.Context, in *KillRequest, opts ...grpc.CallOption) (*KillResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskService_Kill_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) Wait(ctx context.Context, in *WaitRequest, opts ...grpc.CallOption) (*WaitResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskService_Wait_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TaskService_Kill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_Kill_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "feos.task.v1.TaskService",
